...
import { registerGetBountyGenerationDraft } from "./tools/getBountyGenerationDraft";
import { registerUpdateBountyRequirements } from "./tools/updateBountyRequirements";
import { registerUpdateGeneratedTests } from "./tools/updateGeneratedTests";
...
export function createMcpServer(options?: McpServerOptions): McpServer {
  ...
  registerGetBountyGenerationDraft(server);
  registerUpdateBountyRequirements(server);
  registerUpdateGeneratedTests(server);
